...
- GNOME has been upgraded to 42. Please take a look at their [Release Notes](https://help.gnome.org/misc/release-notes/42.0/) for details. Notably, it replaces gedit with GNOME Text Editor, GNOME Terminal with GNOME Console (formerly King’s Cross), and GNOME Screenshot with a tool built into the Shell.
